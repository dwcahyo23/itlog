...
app.post('/save', (req, res) => {
    let data = {nik: req.body.nik,firstName: req.body.firstName, lastName: req.body.lastName,
        email: req.body.email,password: req.body.password, departement: req.body.departement};
    req.getConnection(function (error, conn) {        
